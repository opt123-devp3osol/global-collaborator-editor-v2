(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@tiptap/core'), require('@tiptap/pm/state')) :
  typeof define === 'function' && define.amd ? define(['@tiptap/core', '@tiptap/pm/state'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["tiptap-extension-auto-joiner"] = factory(global.core, global.state));
})(this, (function (core, state) { 'use strict';
  ...
  */
  ...
  function autoJoin(tr, // An old transaction
  newTr, // The latest state
  nodeTypes // The node type to join
  ) {
