...
.tb-subpage-title-with-icon::before {
  content: '';
  display: inline-block;
  margin-top: -4px;
  vertical-align: middle;
...
.temp_draft_task_creation {
    background: rgb(255 0 0 / 10%);
    border-bottom: 2px dotted #ff0000;
    display: inline;
}

.tipt-comment-draft,.tipt-comment-orig {
